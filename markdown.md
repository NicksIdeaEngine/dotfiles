...
Emphasize, aka italics, with one asterisk around text ( *asterisks* ) or one underscore ( _underscores_ )

Strong emphasis, aka bold, with double asterisks ( **asterisks** ) or double underscores ( __underscores__ )
...
7. Ordered sub-list. It's #2, not #7!
6. And another item.

    You can have properly indented paragraphs. Notice the blank line above, and the leading spaces.

*(dots are used to show where spaces would be, but don't use dots in your files! just spaces)*
...
[I'm a reference-style link][Arbitrary case-insensitive reference text] *(this is referencing a link 14 lines below this one)*

[I'm a relative reference to a repository file](../blob/master/LICENSE)

[You can use numbers for reference-style link definitions][1] *(referencing a link 11 lines below this one)*

Or leave it empty and use the [link text itself]. *(referencing a link 10 lines below this one)*
